...
public class BluetoothActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bluetoothAdapter = BluetoothAdapter.getDefaultAdapter();    //Verificando si el dispositivo soporta navegación BT
    }
    ...
    public void onToggleClicked(View view) {
        ...
        if (bluetoothAdapter == null) {
            ...
            if (toggleButton.isChecked()){ // to turn on bluetooth
                if (!bluetoothAdapter.isEnabled()) { // Si el BT está inactivo, se activa por medio del startActivityForResult
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) { //Verificando la habilitación del BT
    ...
    protected void makeDiscoverable(){  //Hacer dispositivo disponible para otros dispositivos BT
